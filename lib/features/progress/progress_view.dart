...
import 'widgets/exercise_performance_card.dart';
import 'widgets/skill_tree_progress_card.dart';

/// Progress tab — exercise performance trends up top, then every skill tree
/// as a node map with the user's path highlighted.
    ...
    return Column(
      ...
      children: [
        const SectionHeader(
          ...
          sub: 'Reps and holds, last 4 sessions',
        ),
        ExercisePerformanceCard(rows: metrics.exercisePerformance),
        SectionHeader(
          title: 'Skill trees',
